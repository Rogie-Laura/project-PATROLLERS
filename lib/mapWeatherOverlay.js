...
export const MAP_WEATHER_OVERLAY_OPTIONS = [
  ...
  },
  {
    ...
    label: "Weather map",
    description:
      "Zoom Earth–style view: infrared satellite clouds + live rain radar (RainViewer).",
    requiresOpenWeatherMap: false,
    free: true,
  },
  {
    ...
    label: "Rain radar",
    description: "Live precipitation radar only (RainViewer, NEXRAD colors).",
    requiresOpenWeatherMap: false,
    free: true,
  },
  {
    ...
    label: "Satellite IR",
    description: "Infrared satellite cloud imagery (RainViewer).",
    requiresOpenWeatherMap: false,
    free: true,
  },
  {
