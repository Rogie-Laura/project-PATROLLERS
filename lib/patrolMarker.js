...
const MARKER_SIZE_PX = 42;
const MARKER_BORDER_PX = 4;
const CAR_IMAGE_PX = 28;
...
export function createPatrolMarkerIcon(
  ...
  return L.divIcon({
    ...
    "><img src="${PATROL_CAR_MARKER_SRC}" alt="" width="${CAR_IMAGE_PX}" height="${CAR_IMAGE_PX}" style="object-fit:contain;display:block;pointer-events:none;" /></div>`,
