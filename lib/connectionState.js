...
// Border colors per connection/signal state (list/detail panel dots — map pin glow is separate).
export const CONNECTION_BORDER_COLOR = {
  ...
  stale: "#9ca3af", // muted — no recent heartbeat/GPS (list/detail only)
};
...
export const CONNECTION_LABEL = {
  ...
  stale: "Sharing · signal lost",
};

/** Unit detail panel — ops-friendly wording. */
export const LIVE_STATUS_LABEL = {
  strong: "Sharing live",
  weak: "Sharing · weak signal",
  delayed: "Sharing · update delayed",
  stale: "Sharing · signal lost",
};

export const HEARTBEAT_INTERVAL_MS = 60_000;
export const HEARTBEAT_WEAK_MS = 120_000;
...
/** Allow ~3 missed GPS reports before marking stale (3 min interval → ~13 min). */
