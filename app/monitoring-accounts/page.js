...
import MonitoringAccountsManager from "@/components/MonitoringAccountsManager";
import MonitorHeader from "@/components/MonitorHeader";
import MapToolbar from "@/components/MapToolbar";
import { canManageUsers } from "@/lib/mobile/adminRoles";
  ...
  useEffect(() => {
    ...
    fetch("/api/auth/me")
      ...
      .then((data) => {
        ...
        if (!data.user || !canManageUsers(data.user.role)) {
          router.replace("/");
          return;
        }
