  ...
  const [fcmResult, broadcastResult] = await Promise.all([
    sendFcmToAccessToken(
      ...
      { type: "dispatch", dispatch_id: dispatchId },
      {
        priority: "high",
        notification: {
          title: "PATROLLERS Dispatch",
          body: "Incident alert — open the app to respond.",
        },
      }
    ),
    ...
    sendFcmToAccessToken(
      ...
      { type: "location_request", item_id: itemId, mode },
      {
        ...
        ...(isAlarm
          ? {
              notification: {
                title: "PATROLLERS — Location Request",
                body: "Command Center is fetching your location. Tap Send Location.",
              },
            }
          : {}),
      }
