...
export async function getSystemSettings() {
  try {
    ...
    const { data, error } = await admin
      ...
      .select(
        "location_interval_seconds, directions_provider, incident_radius_rings, mobile_latest_version_code, mobile_min_version_code, mobile_latest_version_name, mobile_apk_download_url, mobile_update_required, mobile_release_notes, command_feature_flags"
      )
      .eq("id", "default")
      .maybeSingle();
