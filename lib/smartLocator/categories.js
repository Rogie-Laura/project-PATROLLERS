...
export const SMART_LOCATOR_MENU = [
  {
    ...
    color: "#7c3aed",
    items: [
      item("pnp_camps", "PNP Camps"),
      item("pnp_offices", "PNP Offices"),
      item("stations", "Stations"),
      item("sub_stations", "Sub-Stations"),
      item("pcp", "PCP"),
      item("pac_base", "PAC Base"),
      item("bcp", "BCP"),
      item("sscp", "SSCP"),
    ],
  },
  {
    ...
    color: "#2563eb",
    items: [
      item("phil_army", "Phil Army"),
      item("phil_navy", "Phil Navy"),
      item("phil_airforce", "Phil Airforce"),
      item("phil_marines", "Phil Marines"),
      item("pcg", "PCG"),
      item("bfp", "BFP"),
      item("bjmp", "BJMP"),
    ],
